        ...
        <div className="min-h-screen w-full flex items-center justify-center bg-tg-dark p-4">
            <div className="w-full max-w-[400px] bg-tg-panel rounded-2xl p-8 shadow-lg border border-white/5">
                <div className="flex flex-col items-center text-center mb-8">
                    <div className="w-16 h-16 rounded-2xl bg-tg-blue flex items-center justify-center text-white mb-4 shadow-md">
                        <MessageSquare size={32} strokeWidth={2} />
                    </div>
                    <h1 className="text-2xl font-bold text-tg-text mb-1">Sign in to telechat</h1>
                ...
                <p className="text-center text-[15px] text-tg-muted mt-6">
                    <Link to="/register" className="text-tg-badge hover:underline font-medium">
                        Create an Account
                    </Link>
                </p>
            </div>
